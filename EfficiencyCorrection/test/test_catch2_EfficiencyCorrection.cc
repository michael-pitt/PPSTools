...
static constexpr auto s_tag = "[EfficiencyCorrection]";

TEST_CASE("Standard checks of EfficiencyCorrection", s_tag) {
  const std::string baseConfig{
R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("EfficiencyCorrection"
